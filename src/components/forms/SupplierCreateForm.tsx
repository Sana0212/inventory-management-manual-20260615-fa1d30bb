...
export function SupplierCreateForm({ onSuccess, onCancel }: FormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-lg shadow-sm border border-slate-200">
      <div className="border-b border-slate-100 pb-4">
        <h3 className="text-lg font-semibold text-slate-900">New Supplier Details</h3>
        <p className="text-sm text-slate-500">Provide basic and contact information for the supplier.</p>
      </div>
